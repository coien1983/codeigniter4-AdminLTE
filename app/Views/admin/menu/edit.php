                ...
                <div class="box box-primary">
                    ...
                    <form id="dataForm" class="dataForm form-horizontal" action="" method="post"
                        ...
                        <div class="box-body">
                            <div class="fields-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        <input maxlength="50" id="menu_name" name="menu_name" value="<?php echo $data['menu']['menu_name']?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <select class="form-control" name="menu_url" id="menu_url">
                                            <?php echo folder_controller_method_options($aci_config,$data['menu']['folder'], $data['menu']['controller'], $data['menu']['method']); ?>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        <div class="input-group iconpicker-container">
                                            ...
                                            <input maxlength="30" id="icon" name="icon"
                                                   value="<?php echo $data['menu']['css_icon']?>" class="form-control "
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        <div class="input-group">
                                            <input max="9999" min="1" type="number" id="sort_id" name="list_order"
                                                   value="<?php echo $data['menu']['list_order']?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        <input class="input-switch" id="is_show" value="1" <?php if($data['menu']['is_display'] == 1) echo "checked";?> type="checkbox"/>
                                        <input class="switch" id="is_display" name="is_show" value="<?php echo $data['menu']['is_display']?>"
                                               placeholder="" hidden/>
                                    </div>
                                </div>
                                <script>
                        ...
                        <div class="box-footer">
                            ...
                            <div class="col-sm-10 col-md-4">
                                <div class="btn-group">
                                    <input type="hidden" id="menu_id" name="menu_id" value="<?php echo $data['menu']['menu_id']?>">

                    ...
                    <form id="dataForm" class="form-horizontal dataForm" action="" method="post"
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-4">
                                    <input maxlength="50" id="title" name="title" value=""
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-4">
                                    <textarea name="desc" id="desc" cols="70" rows="10" placeholder="请填写新闻描述"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-4">
                                    <input id="c_image" name="c_image"  placeholder="请上传封面图" data-initial-preview="" type="file" class="form-control field-image" >
                                    <input type="hidden" id="real_image" value="">
                                </div>
                            </div>
                        ...
                        <div class="box-footer">
                            ...
                            <div class="col-sm-10 col-md-4">
                                ...
                                <div class="btn-group">
                                    <button type="submit" id="addNews" class="btn flat btn-info dataFormSubmit">
                                        保存
                                    </button>
                                </div>
                                <div class="btn-group">
...
<script>
    ...
    $(document).on("click","#addNews",function (e) {
        ...
        $.ajax({
            url:"/admin/credit/addNews",
            type:"POST",
            data:{title:title,desc:desc,c_image:c_image,content:content,id:0},
            dataType:"JSON",
